...
def run_inference(segmentor_model, output_dir, cad_path, rgb_path, depth_path, cam_path, stability_score_thresh):
    ...
    # print the size of the templates and masks
    logging.info(f"Templates size: {templates.shape}, Masks size: {masks.shape}, Boxes size: {boxes.shape}")
    ...
    # print("appe_scores: ", appe_scores)
    # print("geometric_score: ", geometric_score)
    # print("visible_ratio: ", visible_ratio)
    # TODO: geometric_score is not used here due to faulty iou calculation
    final_score = (semantic_score + 1*appe_scores + 1*visible_ratio) / (1 + 1 + visible_ratio)
